...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_ATTRIBUTE = "Invalid attribute provided";
    public static final String MESSAGE_INVALID_NEW_VALUE = "Invalid new value provided, new value same as old";
